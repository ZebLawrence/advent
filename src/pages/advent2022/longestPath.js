const longestDistanceNode = (distances, visited) => {
	let longest = null;
...
const findLongestPathWithLogs = (graph, startNode, endNode) => {
		...
		for (let child in children) {
			...
			if (String(child) === String(startNode)) {
				...
				if (!distances[child] || distances[child] < newdistance) {
					...
					console.log("not updating, because a longer path already exists!");
				}
			}
		}
	...
	// return the longest path from start node to end node & its distance
	let results = {
...
export default findLongestPathWithLogs;
...
// export default findShortestPathWithLogs;